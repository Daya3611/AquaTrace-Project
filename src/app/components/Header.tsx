    ...
    <header className='fixed top-0 left-0 w-full bg-white shadow-md z-50'>
      <div className='flex justify-between items-center py-4 px-6 lg:px-12'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <Button className='hidden lg:block rounded-full bg-gradient-to-r from-blue-500 via-blue-700 to-blue-900 text-white hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500'>
